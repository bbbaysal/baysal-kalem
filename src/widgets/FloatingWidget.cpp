...
void FloatingWidget::addLabel(QString text, QColor color) {
    ...
    brandingLabel->setText("<div style='text-align: center;'><a href=\"https://bekirberginbaysal.blogspot.com/\" style=\"color: " + color.name() + "; text-decoration: none; font-size: " + QString::number(14 * scale) + "px;\">" + text + "</a><br><span style=\"font-size: " + QString::number(6 * scale) + "px; color: red; font-weight: normal; line-height: 100%;\">v" + QString(APP_VERSION) + "</span></div>");
