...
public:
    ...
    QMap<qint64, bool> is_dragging;
    QPixmap image;
    QColor penColor;
    MovableWidget* cropWidget;
    MovableWidget* magnifierWidget;
    MovableWidget* coordinateWidget;
    MovableWidget* rulerWidget;
    MovableWidget* protractorWidget;
    int penSize[10];
    int max = 99;
    void createMagnifierFromPixmap(QPixmap pix);
    void clearMagnifier();
    void toggleCoordinateTool();
    void toggleRulerTool();
    void toggleProtractorTool();
    ...
    void mergeSelection();
    void clearSelection();
    void setMagnifierSelected(bool selected);
    void setCoordinateSelected(bool selected);
    void setRulerSelected(bool selected);
    void setProtractorSelected(bool selected);
    void createSelectionFromPixmap(QPixmap pix);
...
protected:
    ...
    QPointF last_begin = QPointF(0,0);
    QPointF last_end = QPointF(0,0);
};
