...
char* get_icon_by_id(int id){
    switch(id){
        ...
        case LINE_ORTHO:
            return (char*)":images/shape/line_ortho.svg";
        case VECTOR_ORTHO:
            return (char*)":images/shape/vector_ortho.svg";
        case VECTOR2_ORTHO:
            return (char*)":images/shape/vector2_ortho.svg";
        case TRANSPARENT:
        ...
        case SELECTION:
            return (char*)":images/tool/RPG-Curved-Cursor.svg";
        case NORMAL:
        ...
        case CURSOR:
            return (char*)":images/tool/finger.svg";
        case MINIFY:
        ...
        case UTILMENU:
            return (char*)":images/fx.png";
        case SAVE:
            return (char*)":images/page/file-save.svg";
        case OPEN:
            return (char*)":images/page/file-open.svg";
        case BUYUTEC:
            return (char*)":images/buyutec.svg";
        case COORDINATE:
            return (char*)":images/tool/coordinate.svg";
        case RULER:
            return (char*)":images/tool/ruler.svg";
        case ACIOLCER:
            return (char*)":images/overlay/aciolcer.png";
    }
    return (char*)"";
}
