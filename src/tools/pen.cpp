...
void setupPenType(){
    ...
    penButtons[LINE_ORTHO] = create_button(LINE_ORTHO, [=](){
        setPenStyle(LINE_ORTHO);
    });

    penButtons[VECTOR_ORTHO] = create_button(VECTOR_ORTHO, [=](){
        setPenStyle(VECTOR_ORTHO);
    });

    penButtons[VECTOR2_ORTHO] = create_button(VECTOR2_ORTHO, [=](){
        setPenStyle(VECTOR2_ORTHO);
    });
