...
public:
    ...
    MainWindow() {
        ...
        scale = (screen->size().height() / 1080.0) * 0.7;
        if(scale < 0.2){
            scale = 0.2;
        }
        // set attributes
    ...
    void showCloseDialog(){
        QMessageBox msgBox;
        msgBox.setWindowTitle("Baysal Kalem");
...
void mainWindowInit(){
    ...
    mainWindow->setWindowTitle(QString("Baysal Kalem"));
    mainWindow->setWindowIcon(QIcon(":ikon.png"));
